...
Motor driveLeft1 (1, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES);
Motor driveLeft2 (2, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES);
Motor driveRight1 (10, E_MOTOR_GEARSET_18, true,E_MOTOR_ENCODER_DEGREES);
Motor driveRight2 (9, E_MOTOR_GEARSET_18, true, E_MOTOR_ENCODER_DEGREES);

Motor flywheel (14, E_MOTOR_GEARSET_06, false, E_MOTOR_ENCODER_DEGREES);
Motor indexer (2, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES);
Motor intake (6, E_MOTOR_GEARSET_18, true, E_MOTOR_ENCODER_DEGREES);

Motor descorer (5, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES);
